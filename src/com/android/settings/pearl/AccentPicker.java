...
package com.android.settings.pearl;
...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private boolean isUsingDarkTheme() {
        ...
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.dark.pearl",
    ...
    private boolean isUsingBlackTheme() {
        OverlayInfo themeInfo = null;
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.black.pearl",
                    UserHandle.USER_CURRENT);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
